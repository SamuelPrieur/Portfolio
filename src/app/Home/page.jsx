...
function Home() {
  return (
    ...
    >
      <main className="font-text text-Text leading-normal cursor-none bg-Background">
        <Cursor />
        <div className="flex justify-center items-center p-7 h-full ">
          <div className="grid  grid-cols-10 gap-4 gap-y-36 w-full">
            <section className="col-span-10 grid  grid-cols-10 gap-4 w-full">
              ...
              <section className="Block my-element top-in bg-noise-pattern col-span-6">
                <Image
              ...
              <section className="Block my-element top-in bg-noise-pattern col-span-4">
              ...
              <section className="grid auto-rows-auto lg:grid-cols-4 md:grid-cols-2 xsm:grid-cols-2 gap-4 col-span-10">
                <a
                  ...
                  className="Block my-element top-inbg-noise-pattern portail justify-center flex items-center lg:col-start-1 text-xl rounded-full lg:p-4 md:p-3 xsm:p-7"
                >
                  <p>Call me</p>
                </a>
                <a
                  ...
                  target="_blank"
                  className="Block my-element top-inbg-noise-pattern portail justify-center flex items-center lg:col-start-2 text-xl rounded-full lg:p-4 md:p-3 xsm:p-7"
                >
                  <p>Linkedin</p>
                </a>
                <a
                  ...
                  target="_blank"
                  className="Block my-element top-inbg-noise-pattern portail justify-center flex items-center lg:col-start-3 text-xl rounded-full lg:p-4 md:p-3 xsm:p-7"
                >
                  Github
                </a>
                <a className="Block my-element top-inbg-noise-pattern portail justify-center flex items-center lg:col-start-4 text-xl rounded-full lg:p-4 md:p-3 xsm:p-7">
                  Access My CV
                </a>
              </section>
            </section>
            <section className="Block my-element top-inbg-noise-pattern col-span-4">
              <Image
                className="grayscale h-full rounded-2xl"
                src="/GIGI.webp"
                width={500}
                height={600}
                priority={false}
            ...
            <section className="Block my-element top-inbg-noise-pattern portail col-span-6 text-6xl p-4">
              <h2>
            ...
            <section className="Block my-element top-inbg-noise-pattern portail col-span-10 p-4">
              Slider en cours de construction !
            </section>

            <section className="Block my-element top-inbg-noise-pattern col-span-10 text-wrap ">
            ...
            <section className="Block my-element top-inbg-noise-pattern col-span-10 text-wrap grid grid-cols-10 Projects">
            ...
            <section className="Block my-element top-inbg-noise-pattern col-span-10 text-wrap grid grid-cols-10 Projects">
              ...
              <h2 className="text-2xl col-start-6 col-span-3 ">
                I had to create a platform for game developers to communicate
                with their game testers.
              </h2>
              <Image
                className="portail view h-28 col-start-10 fleche"
                width={200}
            ...
            <section className="Block my-element top-inbg-noise-pattern col-span-5 text-wrap grid grid-cols-4 Projects">
              <h1 className="text-5xl col-start-1 col-span-3 pb-10">
                MMI Poster.
                <br />
                <span className="text-SmText text-2xl">
            ...
            <section className="Block my-element top-inbg-noise-pattern justify-center flex items-center col-span-5">
              <h1 className="text-5xl col-start-1 col-span-3 pb-10">
                More to come.
              </h1>
            </section>
            <section className="col-span-10">
              <section className="Block my-element top-inbg-noise-pattern justify-center flex items-center flex-col p-4 mb-4 self-center text-center text-5xl ">
                <Image
                  className="m-8"
                  src="/logo.svg"
                  width={200}
